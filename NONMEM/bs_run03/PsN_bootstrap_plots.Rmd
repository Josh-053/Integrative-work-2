...
#Created 2025-12-04 at 03:42

xpose.runno <- '03.mod'
toolname <- 'bootstrap'
pdf.filename <- paste0('PsN_',toolname,'_plots.pdf')
working.directory<-'/home/ali/Documents/GitHub/Integrative-work-2/NONMEM/bs_run03/'
results.directory <- '..'
...
ESTIMATED.PARAMS <- c('','_','__','___','____','_____','______','_______','________','_________')
