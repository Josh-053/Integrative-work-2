...
#Created 2025-11-28 at 10:45

xpose.runno <- '00.mod'
toolname <- 'execute'
pdf.filename <- paste0('PsN_',toolname,'_plots.pdf')
working.directory<-'/home/ali/Documents/GitHub/Integrative-work-2/NONMEM/modelfit_dir14/'
results.directory <- '..'
subset.variable<-NULL
tab.suffix <- '' 
rscripts.directory <- '/usr/local/share/perl5/5.40/PsN_5_6_0/R-scripts' # This is not used
raw.results.file <- 'raw_results_run00.csv'
theta.labels <- c('','_')
theta.fixed <- c(FALSE,FALSE)
omega.labels <- c('__','___')
omega.fixed <- c(FALSE,FALSE)
sigma.labels <- c('____','_____')
sigma.fixed <- c(FALSE,FALSE)
n.eta <- 2
n.eps <- 2

res.table <- 'run00_cotab'
