...
$TABLE
ID TIME TAD DV CONC_ID EVID PRED CWRES MDV IPRED WRES RES CL ETA(1) V1 ETA(2) V2 Q K10 K12 K21 KD N SEX ETHNI BW ALB SCR eGFR AGE NOPRINT ONEHEADER FILE=run02
