...
0.1;; not yet known, outcome picked for next models, put a relatively small number
0.1;; not yet known, outcome picked for next models
...
ID TIME DV EVID PRED IPRED WRES RES CWRES NOPRINT ONEHEADER FILE=run04_sdtab

$TABLE ;; output table for PK parameters
ID CL V K NOPRINT NOAPPEND ONEHEADER FILE=run04_patab

$TABLE ;; output table for categorical covariates
ID SEX ETHNI NOPRINT NOAPPEND ONEHEADER FILE=run04_catab

$TABLE ;; output table for continuous covariates
ID BW ALB SCR eGFR AGE NOPRINT NOAPPEND ONEHEADER FILE=run04_cotab
