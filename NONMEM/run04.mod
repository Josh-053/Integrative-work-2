;; 1. Based on: run02
;; 2. Description: CeftriaxPro Base Model - BW~CL
;; x1. TEAM2
;; 2025-12-01
...
ID TIME DV EVID PRED CWRES MDV IPRED WRES RES CWRES NOPRINT ONEHEADER FILE=run04_sdtab

$TABLE ;; output table for PK parameters
ID CL V1 V2 Q K10 K12 K21 KD N NOPRINT NOAPPEND ONEHEADER FILE=run04_patab
