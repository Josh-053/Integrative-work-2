...
#Created 2025-12-02 at 10:27

xpose.runno <- '02.mod'
toolname <- 'vpc'
pdf.filename <- paste0('PsN_',toolname,'_plots.pdf')
working.directory<-'/home/ali/Documents/GitHub/Integrative-work-2/NONMEM/vpc_run02_TAD/'
results.directory <- '..'
...
if (is.tte) {
    ...
    plots <- xpose4::xpose.VPC(vpc.info=tool.results.file,
                               vpctab=vpctab,
                               logy = TRUE)
}
print(plots) 
